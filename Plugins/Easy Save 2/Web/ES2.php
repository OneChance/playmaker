...
// *** GENERAL DETAILS ***
// Replace these with your Unity username and password.
...
if($_POST['username'] != $unityUsername || $_POST['password'] != md5($unityPassword))
{
...
if($_POST["mode"] == "upload")
{
													...
													ON DUPLICATE KEY UPDATE $dataFieldName=VALUES($dataFieldName)")))
	{
		...
		$dataStatement -> bind_param("ssi", $_POST['tag'], $_POST['data'], $fileId);
